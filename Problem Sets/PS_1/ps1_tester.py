...
if student_a:
    print("----PART A Test 1----")
    print(
        "RUNNING with yearly_salary: 112000, portion_saved: .17, cost_of_dream_home: 750000"
    )
    ...
    print("----PART A Test 2----")
    print(
        "RUNNING with yearly_salary: 65000, portion_saved: .20, cost_of_dream_home: 400000"
    )
    yearly_salary = 65000
    portion_saved = 0.20
    ...
    print("----PART A Test 3----")
    print(
        "RUNNING with yearly_salary: 350000, portion_saved: .3, cost_of_dream_home: 10000000"
    )
...
if student_b:
    print("----PART B Test 1----")
    print(
        "RUNNING with yearly_salary: 110000, portion_saved: .15, cost_of_dream_home: 750000, semi_annual_raise: .03"
    )
    ...
    print("----PART B Test 2----")
    print(
        "RUNNING with yearly_salary: 350000, portion_saved: .3, cost_of_dream_home: 10000000, semi_annual_raise: .05"
    )
    yearly_salary = 350000
    portion_saved = 0.3
    cost_of_dream_home = 10000000
...
if student_c:
    ...
    if type(student_r) == str or (
        abs(student_savings - total_down_payment) > 100
        or abs(student_steps - actual_steps) > 2
    ):
        print("FAILED")
        print(
            "Part C Test 1 failed. Either your r value",
            student_r,
            "does not produce the correct savings, or your algorithm takes too few or too many steps. Expected answer:",
            actual_r,
            "in",
            actual_steps,
            "steps",
    ...
    if type(student_r) == str or student_steps != actual_steps:
        print("FAILED")
        print(
            "Part C Test 2 failed. Either your r value",
            student_r,
            "does not produce the correct savings, or your algorithm takes too few or too many steps. Expected answer:",
            actual_r,
            "in",
    ...
    if not student_r == actual_r:
        print("FAILED")
        print(
            "Part C test 3 failed. Correct answer:", actual_r, "your_answer", student_r
        )
