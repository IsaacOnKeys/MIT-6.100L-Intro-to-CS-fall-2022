...
w_one = Workout("01/01/2021 15:30", "01/01/2021 16:00")
cals1 = w_one.get_calories()
# print(cals1)
...
w_two = Workout("01/01/2021 15:35", "01/01/2021 16:00", 300)
...
def total_elapsed_time(L):
    ...
    for i in L:
        total_elapsed_time += (parser.parse(i[1]) - parser.parse(i[0])).total_seconds()
