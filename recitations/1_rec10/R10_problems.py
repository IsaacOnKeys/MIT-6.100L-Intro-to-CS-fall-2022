...
"""
O(n) = linear search. Go through each element of the list, keeping track of the largest one "so Far" until the end, then return the largest.

n**2 = quadratic time. Use a nested loop where the inner loop compares each of the numbers in the list with each of it's own indeces. 
"""
